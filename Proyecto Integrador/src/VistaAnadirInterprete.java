...
public class VistaAnadirInterprete extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VistaAnadirInterprete() {
		setTitle("Añadir nuevo interprete");
	...
	public void setControlador (ControladorAnadirInterprete c){
