...
public class VistaModificarTransportenac extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VistaModificarTransportenac() {
		setTitle("Modificar transporte nacional");
		...
		btnModificar.setBounds(307, 63, 97, 25);
	...
	public void setControlador (ControladorModificarTransportenac c){
