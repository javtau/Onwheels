...
public class VistaModificarAgente extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VistaModificarAgente() {
		setTitle("Modificar agente de aduanas");
	...
	public void setControlador (ControladorModificarAgente c){
